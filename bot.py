...
@flask_app.route('/')
def index():
    """Main page - redirect to mini app"""
    return """
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body>
        <div class="container">
            ...
            <p>Welcome to Christian Vent web interface</p>
            <p>Please use the Telegram bot to access the mini app.</p>
            <div style="margin-top: 30px;">
                <a href="/mini_app" class="btn">Go to Mini App</a>
...
def mini_app_page():
    ...
    <body>
        <div class="app-container">
            ...
            <div class="actions">
                <button class="action-btn" onclick="openBot()">
                    📱 Open Telegram Bot
                </button>
                <a href="https://t.me/test_bot_1_bot?start=ask" class="action-btn">
                    📝 Share Your Thought
                </a>
                <a href="https://t.me/test_bot_1_bot?start=profile" class="action-btn">
                    👤 View Profile
                </a>
                <a href="https://t.me/test_bot_1_bot?start=leaderboard" class="action-btn">
                    🏆 Leaderboard
                </a>
            </div>
            
            <div style="margin-top: 30px; text-align: center; color: rgba(255,255,255,0.7);">
                <p>Connected to: https://test-bot-1-4ao0.onrender.com</p>
            </div>
        </div>
        ...
        <script>
            ...
            if (tg.initDataUnsafe) {
                ...
                tg.setBackgroundColor('#4f46e5');
                
                // Use Telegram user ID
                const tgUserId = tg.initDataUnsafe.user?.id;
                if (tgUserId) {
                    document.getElementById('userId').textContent = tgUserId;
                }
            }
            
            function openBot() {
                window.open('https://t.me/test_bot_1_bot', '_blank');
            }
        </script>
    </body>
    </html>
